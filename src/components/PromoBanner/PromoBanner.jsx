...
function PromoBanner() {
  return (
    <section id="main" className="bg-promo-banner-bg bg-[top_right_-15rem] md:bg-right bg-no-repeat bg-cover pt-[25vw] md:pt-[295px] xl:pt-[216px] pb-[14px] md:pb-[160px] h-[100vh] md:h-[initial]">
      <div className="container">
        <div className="md:max-w-[442px] xl:max-w-none md:ml-auto xl:flex xl:space-x-[200px] xl:items-center">
          <div className="xl:w-1/2">
            <figure className={`transition-all mx-auto mb-[20vw] md:mb-[123px] ${styles['fade-in']}`}>
